...
public class ServiceChooseForAddMore extends JInternalFrame{
  ...
  public ServiceChooseForAddMore(JInternalFrame owner) {
    try {
    	this.owner = owner;
...
private void loadAllService(){
  ...
  private void jbInit() throws Exception {
    ...
    btnCancel.addActionListener(new ServiceChooseForAddMore_btnCancel_actionAdapter(this));
    btnOk.addActionListener(new ServiceChooseForAddMore_btnOk_actionAdapter(this));
  }
  ...
  void btnOk_actionPerformed(ActionEvent e) {
	  ...
	  for(int i=0; i<rowcount; i++){
		  if(tblService.getModel().getValueAt(i, 0).toString() == "true"){
			  ...
			  ((AddCheckinServiceForm)owner).tblModelService.insertRow(j++, new Object[]{sevID, tblService.getModel().getValueAt(i, 2), tblService.getModel().getValueAt(i, 3)});
			  total += Double.parseDouble(tblService.getModel().getValueAt(i, 3)+ "");
		  }
		  
	  }
	  
		  double totalcost = Double.parseDouble(((AddCheckinServiceForm)owner).txtTotalAmt.getText())+ total;
		  ((AddCheckinServiceForm)owner).txtTotalAmt.setText(totalcost + "");
...
class ServiceChooseForAddMore_btnOk_actionAdapter implements java.awt.event.ActionListener {
	ServiceChooseForAddMore adaptee;

  ServiceChooseForAddMore_btnOk_actionAdapter(ServiceChooseForAddMore adaptee) {
...
class ServiceChooseForAddMore_btnCancel_actionAdapter implements java.awt.event.ActionListener {
	ServiceChooseForAddMore adaptee;

	ServiceChooseForAddMore_btnCancel_actionAdapter(ServiceChooseForAddMore adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
